...
urlpatterns = [
    ...
    path('fetch/item-category/del/', views.fetch_del_item_category, name='fetch_del_item_category'),
    path('fetch/item-record/create/', views.fetch_add_item_record, name='fetch_add_item_record'),
    path('fetch/item-record/del/', views.fetch_del_item_record, name='fetch_del_item_record'),
